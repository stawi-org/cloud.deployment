# manufacturing — Frame Cloud Run (antinvestor/service-manufacturing apps/default).
# Recipes, inventory, production, quality, traceability. Single service, Neon DB,
# default Pub/Sub events topic. Authz via identity Keto (stawi-identity).
...
module "frame" {
  ...
  oauth2_service_client_id = "service-manufacturing"
