...
class manufacturing_property implements Namespace {
  related: {
    owner: (profile_user | service_manufacturing)[]
    admin: (profile_user | service_manufacturing)[]
    operator: (profile_user | service_manufacturing)[]
    viewer: (profile_user | service_manufacturing)[]
    service: (profile_user | service_manufacturing)[]
