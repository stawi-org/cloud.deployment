...
- **Payments / ledger split** — checkout on `stawi-payments`; ledger + billing on `stawi-ledger` — [docs/DEPLOY_PAYMENTS_LEDGER_COMMS.md](docs/DEPLOY_PAYMENTS_LEDGER_COMMS.md)
...
| [docs/DEPLOY_PAYMENTS_LEDGER_COMMS.md](docs/DEPLOY_PAYMENTS_LEDGER_COMMS.md) | Communications + payments + ledger/billing Cloud Run |
